...
import {removeItems} from "./Slice/Food_Drink_slice"
...
{
  dispatch(removeItems(food))
}


  return (
    <div>
      <div className="h-[3em] w-full flex items-center justify-center">
        Ordered Items
      </div>

      <div>{OrderedDetails?.name}</div>
